...
CREATE TABLE `activity`  (
  `activity_id` char(18)  NOT NULL COMMENT '活动编号',
  `apply_id` char(18)  NOT NULL COMMENT '申请编号',
  `type_id` char(18)  NOT NULL COMMENT '社团类型编号',
  `club_id` char(18)  NULL DEFAULT NULL COMMENT '社团编号',
  `picture` varchar(200)  NULL DEFAULT NULL COMMENT '活动logo',
  `activity_title` varchar(20)  NULL DEFAULT NULL COMMENT '活动主题',
  `activity_intro` varchar(130)  NULL DEFAULT NULL COMMENT '活动介绍',
  ...
  `activity_report` text  NULL COMMENT '活动总结',
  `money` decimal(9, 2) NULL DEFAULT 0.00 COMMENT '活动资金',
  `activity_look` char(18)  NULL DEFAULT NULL COMMENT '活动对象',
...
CREATE TABLE `activity_member`  (
  `user_id` char(18)  NOT NULL COMMENT '账号',
  `activity_id` char(18)  NOT NULL COMMENT '活动编号',
  `stage_id` char(18)  NULL DEFAULT NULL COMMENT '阶段编号',
  `bear_name` varchar(20)  NULL DEFAULT NULL COMMENT '职位',
  `appraise` text  NULL COMMENT '评价',
...
CREATE TABLE `activity_stage`  (
  `stage_id` char(18)  NOT NULL COMMENT '阶段编号',
  `activity_id` char(18)  NOT NULL COMMENT '活动编号',
  `stage_name` varchar(20)  NULL DEFAULT NULL COMMENT '阶段名称',
  `stage_content` text  NULL COMMENT '阶段内容',
  `start_time` datetime(0) NULL DEFAULT NULL COMMENT '开始时间',
  `end_time` datetime(0) NULL DEFAULT NULL COMMENT '结束时间',
...
CREATE TABLE `activity_type`  (
  `type_id` char(18)  NOT NULL COMMENT '活动类型编号',
  `type_name` varchar(20)  NULL DEFAULT NULL COMMENT '类型名',
  `type_content` varchar(130)  NULL DEFAULT NULL COMMENT '类型介绍',
  `picture` varchar(200)  NULL DEFAULT NULL COMMENT '类型logo',
...
-- ----------------------------
INSERT INTO `activity_type` VALUES ('202305041324423735', '文化类', '666', 'http://localhost:8080/images/type/1.jpg');
INSERT INTO `activity_type` VALUES ('202305041324581993', '娱乐类', '666', 'http://localhost:8080/images/type/1.jpg');
INSERT INTO `activity_type` VALUES ('202305041325117850', '兴趣类', '666', 'http://localhost:8080/images/type/1.jpg');
...
CREATE TABLE `apply`  (
  `apply_id` char(18)  NOT NULL COMMENT '申请编号',
  `area_id` char(18)  NOT NULL COMMENT '场地编号',
  `apply_user` char(18)  NOT NULL COMMENT '申请用户',
  `name` varchar(20)  NULL DEFAULT NULL COMMENT '名称',
  `apply_content` varchar(130)  NULL DEFAULT NULL COMMENT '申请理由',
  `apply_time` datetime(0) NULL DEFAULT NULL COMMENT '申请时间',
  `apply_state` tinyint(0) NULL DEFAULT 0 COMMENT '申请状态,状态 0: 审核中 1: 通过 2:未通过 10:保存',
  `reply` varchar(130)  NULL DEFAULT NULL COMMENT '回复',
...
CREATE TABLE `area`  (
  `area_id` char(18)  NOT NULL COMMENT '场地编号',
  `area_name` varchar(20)  NULL DEFAULT NULL COMMENT '场地名',
...
INSERT INTO `area` VALUES ('202305121443022751', '建发505', 1, '2023-05-12 14:43:02', NULL);
...
CREATE TABLE `bear`  (
  `bear_id` char(18)  NOT NULL COMMENT '担任编号',
  `teacher_id` char(18)  NOT NULL COMMENT '账号',
  `bear_name` varchar(20)  NULL DEFAULT NULL COMMENT '职位',
  `contribute` text  NULL COMMENT '贡献',
...
CREATE TABLE `bill`  (
  `bill_id` char(18)  NOT NULL COMMENT '账单号',
  `bill_name` varchar(20)  NULL DEFAULT NULL COMMENT '账单名',
  `bill_belong` char(18)  NULL DEFAULT NULL COMMENT '账单归属',
  `source_id` char(18)  NULL DEFAULT NULL COMMENT '资金来源',
  `user_id` char(18)  NULL DEFAULT NULL COMMENT '使用用户',
  `pay_object` char(18)  NULL DEFAULT NULL COMMENT '支付对象',
  `date` datetime(0) NULL DEFAULT NULL COMMENT '日期',
  `pay_state` tinyint(0) NULL DEFAULT 0 COMMENT '支付状态,0:支付中,1:已支付,2:未支付',
  `bill_type` enum('支出','收入')  NULL DEFAULT '支出' COMMENT '账单类型',
  `remark` varchar(130)  NULL DEFAULT NULL COMMENT '备注',
...
CREATE TABLE `club`  (
  `club_id` char(18)  NOT NULL COMMENT '社团编号',
  `apply_id` char(18)  NOT NULL COMMENT '申请编号',
  `type_id` char(18)  NOT NULL COMMENT '社团类型编号',
  `user_id` char(18)  NOT NULL COMMENT '社长编号',
  `club_name` varchar(20)  NULL DEFAULT NULL COMMENT '社团名称',
  `picture` varchar(200)  NULL DEFAULT NULL COMMENT '社团logo',
  `club_intro` varchar(130)  NULL DEFAULT NULL COMMENT '社团介绍',
  `club_content` text  NULL COMMENT '社团内容',
...
-- Records of club
-- ----------------------------
INSERT INTO `club` VALUES ('202305062302265336', '202305062302263318', '202305032142589815', '000000', '娱乐社团', 'http://localhost:8080/images/type/3.jpg', '丰富学生业余生活', '<p>丰富学生业余生活</p>\n<img src=\"http://localhost:8080/images/text/1.jpg\" alt=\"undefined\" style=\"height: 10rem;width: 18rem\"/>\n<p>嘻嘻</p>\n', 2, 0.00);
...
CREATE TABLE `club_member`  (
  `user_id` char(18)  NOT NULL COMMENT '成员账号',
  `club_id` char(18)  NOT NULL COMMENT '社团编号',
  `bear_name` varchar(20)  NULL DEFAULT NULL COMMENT '职位',
  `contribute` text  NULL COMMENT '社团贡献',
  `join_time` datetime(0) NULL DEFAULT NULL COMMENT '加入时间',
...
CREATE TABLE `club_report`  (
  `report_id` char(18)  NOT NULL COMMENT '总结编号',
  `club_id` char(18)  NOT NULL COMMENT '社团编号',
  `user_id` char(18)  NOT NULL COMMENT '发起人',
  `report_title` varchar(20)  NULL DEFAULT NULL COMMENT '总结主题',
  `report_intro` varchar(130)  NULL DEFAULT NULL COMMENT '介绍',
  `report_content` text  NULL COMMENT '总结内容',
  `picture` varchar(200)  NULL DEFAULT NULL COMMENT '代表图',
  `stage_name` varchar(20)  NULL DEFAULT NULL COMMENT '阶段名称',
...
CREATE TABLE `cost_apply`  (
  `apply_id` char(18)  NOT NULL COMMENT '申请编号',
  `club_id` char(18)  NOT NULL COMMENT '社团申请',
  `apply_user` char(18)  NOT NULL COMMENT '申请用户',
  `apply_content` varchar(130)  NULL DEFAULT NULL COMMENT '申请理由',
  `apply_time` datetime(0) NULL DEFAULT NULL COMMENT '申请时间',
...
CREATE TABLE `menu`  (
  `menu_id` char(18)  NOT NULL COMMENT '菜单编号',
  `name` varchar(10)  NULL DEFAULT NULL COMMENT '单菜名称',
  `href` varchar(100)  NULL DEFAULT NULL COMMENT '访问地址',
  `parent_id` char(18)  NULL DEFAULT NULL COMMENT '上级菜单',
  `sort` tinyint(0) NULL DEFAULT 0 COMMENT '排序',
  `menu_logo` varchar(200)  NULL DEFAULT NULL COMMENT '菜单LOGO',
  `is_show` tinyint(0) NULL DEFAULT 0 COMMENT '是否显示',
  `remarks` varchar(50)  NULL DEFAULT NULL COMMENT '备注',
...
INSERT INTO `menu` VALUES ('202304191451123453', '首页', '/backstage/home', NULL, 127, 'HomeOutlined', 1, NULL);
...
CREATE TABLE `menu_role`  (
  `menu_id` char(18)  NOT NULL COMMENT '菜单编号',
  `role_id` char(18)  NOT NULL COMMENT '角色编号',
  `remark` varchar(50)  NULL DEFAULT NULL COMMENT '备注',
...
INSERT INTO `menu_role` VALUES ('202304191451121861', '202304191414130005', NULL);
...
CREATE TABLE `notice`  (
  ...
  `source_id` char(18)  NULL DEFAULT NULL COMMENT '来源编号',
  `notice_name` varchar(20)  NULL DEFAULT NULL COMMENT '通知名',
  `notice_content` varchar(130)  NULL DEFAULT NULL COMMENT '通知内容',
  `notice_time` datetime(0) NULL DEFAULT NULL COMMENT '通知时间',
  `user_id` char(18)  NOT NULL COMMENT '通知发起者',
  `notice_type` enum('活动通知','社团通知')  NULL DEFAULT '活动通知' COMMENT '通知类型',
  `notice_object` char(18)  NULL DEFAULT NULL COMMENT '通知对象',
...
CREATE TABLE `project`  (
  `project_id` char(18)  NOT NULL COMMENT '项目号',
  `bill_id` char(18)  NOT NULL COMMENT '账单号',
  `project_name` varchar(20)  NULL DEFAULT NULL COMMENT '名称',
...
CREATE TABLE `role`  (
  ...
  `role_logo` varchar(200)  NULL DEFAULT NULL COMMENT '角色logo',
...
CREATE TABLE `sign`  (
  `sign_id` char(18)  NOT NULL COMMENT '签到编号',
  `user_id` char(18)  NOT NULL COMMENT '签到发起者',
  `stage_id` char(18)  NOT NULL COMMENT '阶段编号',
  `sign_type` enum('数字签到')  NULL DEFAULT '数字签到' COMMENT '签到类型',
  `sign_content` varchar(130)  NULL DEFAULT NULL COMMENT '签到内容',
  `sign_reason` varchar(130)  NULL DEFAULT NULL COMMENT '签到理由',
  `start_time` datetime(0) NULL DEFAULT NULL COMMENT '开始时间',
  `end_time` datetime(0) NULL DEFAULT NULL COMMENT '结束时间',
...
CREATE TABLE `student`  (
  `stu_id` char(18)  NOT NULL COMMENT '学号',
  `user_id` char(18)  NOT NULL COMMENT '账号',
  `college` varchar(20)  NULL DEFAULT NULL COMMENT '学院',
  `classes` varchar(20)  NULL DEFAULT NULL COMMENT '班级',
...
CREATE TABLE `teacher`  (
  `teacher_id` char(18)  NOT NULL COMMENT '职工编号',
  `user_id` char(18)  NOT NULL COMMENT '用户编号',
  `college` varchar(20)  NULL DEFAULT NULL COMMENT '学院',
  `position` varchar(20)  NULL DEFAULT NULL COMMENT '职位',
...
CREATE TABLE `user`  (
  ...
  `user_name` varchar(10)  NULL DEFAULT NULL COMMENT '用户姓名',
  `sex` enum('男','女')  NULL DEFAULT '男' COMMENT '性别',
  `phone` char(11)  NULL DEFAULT NULL COMMENT '电话',
  `email` varchar(100)  NULL DEFAULT NULL COMMENT '邮箱',
  `picture` varchar(200)  NULL DEFAULT NULL COMMENT '头像',
  `intro` varchar(130)  NULL DEFAULT NULL COMMENT '个人介绍',
  `regist_time` datetime(0) NULL DEFAULT NULL COMMENT '注册',
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('000000', '$2a$10$l.qpcMvw/g.B6pYhyiz5lus1kOxrhzm8ARpboLwC7/x360XvYb.R.', '张三', '张三', '男', '19859252969', '123@qq.com', 'http://localhost:8080/images/head/1.jpg', '举办本期培训班是为了深入学习贯彻习近平新时代中国特色社会主义思想和党的二十大精神，推动党员干部深刻领悟“两个确立”的决定性意义，增强“四个意识”、坚定“四个自信”、做到“两个维护”，确保在政治立场、政治方向、政治原则、政治道路上同党中央保持高度一致', '2023-05-07 22:05:19');
INSERT INTO `user` VALUES ('123456', '$2a$10$ZzFkDwDmhTdB0YIoVZIlQuRyTIQTIekJ8.yUWchSqdHMYYCasFeXK', '王五', '张三', '男', '12345678912', NULL, 'http://localhost:8080/images/head/2.jpg', '435', '2023-05-07 22:05:19');
...
INSERT INTO `user` VALUES ('202305121438536125', '$2a$10$9oI4B1noJ/6XXA6W9TvP6uCGzhWC4VCQUZZYHj4Gkhzf8anU8Vjn6', '周斌', '周斌', '男', '12345678910', NULL, 'http://localhost:8080/images/head/4.jpg', NULL, NULL);
